...
namespace PPI.Plugin.Report.Infrastructure
{
    ...
    {
        const string PluginName = "PPI.Plugin.Report";
        /// <summary>
        ...
        {
            string Meta = "metadata=res://*/Entities.Report.csdl|res://*/Entities.Report.ssdl|res://*/Entities.Report.msl";
            ...
            {
                if (item.Name == "TemplateEntities")
                {
                    connectionstringTest = true;
                }
                else if (item.Name == "PlatformEntities")
                {
                    existingPlatformConnection = new ConnectionStringSettings("ReportEntities", item.ConnectionString.Replace(item.ConnectionString.Split(char.Parse(";")).First(), Meta), item.ProviderName);
                    //item;
                }
            }
