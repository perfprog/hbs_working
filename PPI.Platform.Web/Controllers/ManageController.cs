    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult ChangeEmail(ChangeEmailViewModel model)
        {
            ...
            {                
                ...
                var currentPerson = _IPlatformUnitOfWork.IPersonRepository.AsQueryable().FirstOrDefault(m => m.Email == model.OrginalEmail);
                if (currentPerson != null)
                { 
                    currentPerson.Email = model.Email;
                    _IPlatformUnitOfWork.IPersonRepository.Update(currentPerson);
                    _IPlatformUnitOfWork.Commit();
                }
                return RedirectToAction("Index", new { Message = "Email Updated" });
            }
            AddErrors(result);
            return View(model);
        }
